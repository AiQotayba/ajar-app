...
import { Calendar, FolderTree, Eye, EyeOff, ListTree } from "lucide-react"
...
export function CategoryView({ open, onOpenChange, urlEndpoint, category }: CategoryViewProps) {
                ...
                <DialogHeader>
                    <DialogTitle className="flex items-center justify-between">
                        ...
                        <Badge
                            ...
                            className={category.is_visible ? "bg-green-500" : "bg-gray-500"}
                        >
                            {category.is_visible ? (
                                <>
                        ...
                        <>
                            <div className="space-y-3">
                                <h3 className="text-sm font-medium flex items-center gap-2">
                                    الخصائص
                                    <Badge variant="secondary">{category.properties.length}</Badge>
                                </h3>
