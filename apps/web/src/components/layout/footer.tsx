...
export function SyriaFlag() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="rounded-xs w-6 h-6" viewBox="0 0 640 480">
      ...
      <path fill="#090" fillRule="evenodd" d="M0 0h640v160H0z" />
      <path fill="red" fillRule="evenodd" d="
